...
Partners.defaultProps = {
    ...
    partnersData: [
        {
            partnerLogo: require("../assets/img/partner-1.png"),
            partnerLink: "#0"
        },
        {
            partnerLogo: require("../assets/img/partner-2.png"),
            partnerLink: "#0"
        },
        {
            partnerLogo: require("../assets/img/partner-3.png"),
            partnerLink: "#0"
        },
        {
            partnerLogo: require("../assets/img/partner-4.png"),
            partnerLink: "#0"
            },
        {
            partnerLogo: require("../assets/img/partner-5.png"),
            partnerLink: "#0"
        },
        {
            partnerLogo: require("../assets/img/partner-6.png"),
            partnerLink: "#0"
        },
        {
            partnerLogo: require("../assets/img/partner-3.png"),
